...
The test plan can be made on Confluence (if you use JIRA for your project) or you can use [this template](https://docs.google.com/spreadsheets/d/1YtMnp1TbfunnfO-IIotO36_evKJX_uxlqmiSWn5KwqM/edit#gid=0). **Feel free to copy this template and use it for your project.**
