...
<span style="display:block; margin-left:auto; margin-right:auto; width:85%;">![git_branches.jpg](/img/git_branches.jpg)</span>
...
5. In the *compare: [branch-name]* dropdown menu choose the branch you made your changes in
	...
	<span style="display:block; margin-left:auto; margin-right:auto; width:85%;">![git_choose_branches_PR.png](/img/git_choose_branches_PR.png)</span>
